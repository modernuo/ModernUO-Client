        ...
        public override void OnResponse(int buttonId, int[] switches, GumpTextEntry[] textEntries = null)
        {
            switch (buttonId)
            {
                case (int)ItemInfoButtons.CopyItemName:
                    ClassicUO.Utility.StringHelper.SetClipboardText(_item.ItemID.ItemData.Name);
                ...
                case (int)ItemInfoButtons.CopySerial:
                    ClassicUO.Utility.StringHelper.SetClipboardText(_item.Serial.ToString());
                ...
                case (int)ItemInfoButtons.CopyId:
                    ClassicUO.Utility.StringHelper.SetClipboardText(_item.ItemID.Value.ToString());
                ...
                case (int)ItemInfoButtons.CopyHue:
                    ClassicUO.Utility.StringHelper.SetClipboardText(_item.Hue.ToString());
